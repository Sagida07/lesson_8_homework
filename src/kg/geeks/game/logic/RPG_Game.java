...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Witcher witcher = new Witcher(350, 0, "Tom");
        Thor thor = new Thor(260, 30, "Killian");
        Bomber bomber = new Bomber(210, 10, "Nikita");
        Spitfire spitfire = new Spitfire(250, 15, "Reiner");
        Samurai samurai = new Samurai(280, 0, "Naruto");
        Hero[] heroes = {warrior, warrior2, doc, magic, berserk, assistant, witcher, thor, bomber, spitfire, samurai};
